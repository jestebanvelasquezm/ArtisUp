        ...
        <div className='  lg:w-full lg:pb-10 lg:mr-10'>
            <form onSubmit={(e) => handleSubmit(e)} className=' flex flex-col justify-center lg:flex-row lg:justify-start'>
                <div className="lg:absolute lg:w-96    lg:justify-end ">
                    ...
                    <input value={input} onChange={(e) => handleChange(e)} type="search" id="default-search" className="lg:block h-11 lg:w-80  text-center text-lg text-gray-800 bg-gray-100 rounded-md border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Buscar..." required />
                </div>
