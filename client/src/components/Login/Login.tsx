                ...
                <div
                    ...
                    <div className="xl:ml-20 xl:w-5/12 lg:w-5/12 md:w-8/12 mb-12 md:mb-0">
                        <form onSubmit={(e) => handleSubmit(e)}>
                            ...
                            <div className="my-6">
                                <button className="flex w-full justify-center rounded-3xl border-none bg-white p-1 text-black hover:bg-gray-200 sm:p-2"><img src="https://freesvg.org/img/1534129544.png" className="mr-2 w-6 object-fill" alt='not found' />Entrar con Google</button>
                            </div>
                            ...
                            <div className="flex justify-between items-center mb-6">
                                <div className="form-group form-check">
                                    <input
                                        ...
                                        id="exampleCheck2"
                                    />
                                    <label className="form-check-label inline-block text-gray-800" htmlFor="exampleCheck2">Recuerdame</label>
                                </div>
                                <a href="#!" className="text-red-600">¿Olvidaste tu contraseña?</a>
                            </div>
                            ...
                            <div className="text-center lg:text-left">
                                ...
                                <p className="text-sm font-semibold mt-2 pt-1 mb-0">
                                    ...
                                    <Link to='/register'>
                                        <p
                                            className="text-red-600 hover:text-red-700 focus:text-red-700 transition duration-200 ease-in-out">Registrate
                                        </p>
                                    </Link>
                                </p>
                            </div>
