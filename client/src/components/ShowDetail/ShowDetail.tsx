...
export default function ShowDetail() {
    ...
    return (
        <div className="flex justify-center text-center my-20 h-auto bg-black">
            <Navbar />

            {(detailUser ) ? <div  className="container flex flex-col items-center w-full h-screen " >
                ...
                {/* </div> */}
                <div className='bg-slate-600 top-10 w-auto  ' >
